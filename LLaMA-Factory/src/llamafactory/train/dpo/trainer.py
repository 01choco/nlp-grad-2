...
class CustomDPOTrainer(DPOTrainer):
    ...
    def compute_preference_loss(
        ...
        # # compute gradient of policy chosen logps and policy rejected logps
        # policy_chosen_logps.retain_grad()
        # policy_rejected_logps.retain_grad()
        # mean_loss.backward(retain_graph=True)
        # # 5) 기울기 확인
        # print("chosen_lops        =", policy_chosen_logps)
        # print("rejected_logps     =", policy_rejected_logps)
        # print("∂L/∂chosen_logps   =", policy_chosen_logps.grad)
        # print("∂L/∂rejected_logps =", policy_rejected_logps.grad)
